# Les exemples ne doivent ni distribuer de récompenses ni envoyer de notifications.
# Ce garde ne dure que pendant le chargement des seeds, y compris pour les jobs
# automatiques d’Active Storage. Le fonctionnement normal est rétabli ensuite.
skip_seed_job = -> { throw :abort }
ActiveJob::Base.set_callback(:enqueue, :before, skip_seed_job, prepend: true)
begin
  ...
  ActiveJob::Base.skip_callback(:enqueue, :before, skip_seed_job)
end
