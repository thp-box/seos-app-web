...
CREATE UNIQUE INDEX "index_achievements_on_slug" ON "achievements" ("slug") /*application='SeosFrance'*/;
...
CREATE INDEX "index_user_achievements_on_user_id" ON "user_achievements" ("user_id") /*application='SeosFrance'*/;
CREATE INDEX "index_user_achievements_on_achievement_id" ON "user_achievements" ("achievement_id") /*application='SeosFrance'*/;
CREATE INDEX "index_user_achievements_on_point_rule_version_id" ON "user_achievements" ("point_rule_version_id") /*application='SeosFrance'*/;
CREATE INDEX "index_user_achievements_on_point_operation_id" ON "user_achievements" ("point_operation_id") /*application='SeosFrance'*/;
CREATE INDEX "index_user_achievements_on_reviewed_by_id" ON "user_achievements" ("reviewed_by_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "unique_achievement_period" ON "user_achievements" ("user_id", "achievement_id", "period_key") /*application='SeosFrance'*/;
...
CREATE INDEX "index_top_listing_requests_on_listing_id" ON "top_listing_requests" ("listing_id") /*application='SeosFrance'*/;
CREATE INDEX "index_top_listing_requests_on_user_id" ON "top_listing_requests" ("user_id") /*application='SeosFrance'*/;
CREATE INDEX "index_top_listing_requests_on_reviewed_by_id" ON "top_listing_requests" ("reviewed_by_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "one_top_listing_request" ON "top_listing_requests" ("listing_id") WHERE status IN ('pending', 'approved') /*application='SeosFrance'*/;
...
CREATE INDEX "index_testimonials_on_user_id" ON "testimonials" ("user_id") /*application='SeosFrance'*/;
CREATE INDEX "index_testimonials_on_point_reward_claim_id" ON "testimonials" ("point_reward_claim_id") /*application='SeosFrance'*/;
CREATE INDEX "index_testimonials_on_reviewed_by_id" ON "testimonials" ("reviewed_by_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_chain_rule_versions_on_created_by_id" ON "chain_rule_versions" ("created_by_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "one_chain_rule_effective_date" ON "chain_rule_versions" ("effective_at") WHERE status = 'published' /*application='SeosFrance'*/;
...
CREATE INDEX "index_help_chains_on_creator_id" ON "help_chains" ("creator_id") /*application='SeosFrance'*/;
CREATE INDEX "index_help_chains_on_chain_rule_version_id" ON "help_chains" ("chain_rule_version_id") /*application='SeosFrance'*/;
CREATE INDEX "index_help_chains_on_point_rule_version_id" ON "help_chains" ("point_rule_version_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_help_chains_on_slug" ON "help_chains" ("slug") /*application='SeosFrance'*/;
...
CREATE INDEX "index_chain_services_on_help_chain_id" ON "chain_services" ("help_chain_id") /*application='SeosFrance'*/;
CREATE INDEX "index_chain_services_on_provider_id" ON "chain_services" ("provider_id") /*application='SeosFrance'*/;
CREATE INDEX "index_chain_services_on_beneficiary_id" ON "chain_services" ("beneficiary_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_chain_services_on_invitation_token_digest" ON "chain_services" ("invitation_token_digest") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_chain_services_on_help_chain_id_and_position" ON "chain_services" ("help_chain_id", "position") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "one_chain_invitation" ON "chain_services" ("help_chain_id") WHERE status = 'invited' /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "unique_chain_beneficiary" ON "chain_services" ("help_chain_id", "beneficiary_id") WHERE status = 'confirmed' /*application='SeosFrance'*/;
...
CREATE INDEX "index_chain_rewards_on_chain_service_id" ON "chain_rewards" ("chain_service_id") /*application='SeosFrance'*/;
CREATE INDEX "index_chain_rewards_on_recipient_id" ON "chain_rewards" ("recipient_id") /*application='SeosFrance'*/;
CREATE INDEX "index_chain_rewards_on_chain_rule_version_id" ON "chain_rewards" ("chain_rule_version_id") /*application='SeosFrance'*/;
CREATE INDEX "index_chain_rewards_on_point_operation_id" ON "chain_rewards" ("point_operation_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_chain_rewards_on_chain_service_id_and_recipient_id" ON "chain_rewards" ("chain_service_id", "recipient_id") /*application='SeosFrance'*/;
CREATE TABLE IF NOT EXISTS "financial_contributions" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "user_id" integer NOT NULL, "request_key" varchar NOT NULL, "amount_cents" integer NOT NULL, "currency" varchar DEFAULT 'eur' NOT NULL, "status" varchar DEFAULT 'pending' NOT NULL, "stripe_session_id" varchar, "payment_intent_id" varchar, "stripe_refund_id" varchar, "refunded_cents" integer DEFAULT 0 NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "refund_requested_at" datetime(6) /*application='SeosFrance'*/, CONSTRAINT "fk_rails_3f6378ff61"
FOREIGN KEY ("user_id")
  REFERENCES "users" ("id")
...
CREATE INDEX "index_financial_contributions_on_user_id" ON "financial_contributions" ("user_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_financial_contributions_on_stripe_session_id" ON "financial_contributions" ("stripe_session_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_financial_contributions_on_payment_intent_id" ON "financial_contributions" ("payment_intent_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_financial_contributions_on_user_id_and_request_key" ON "financial_contributions" ("user_id", "request_key") /*application='SeosFrance'*/;
CREATE TABLE IF NOT EXISTS "payment_events" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "stripe_event_id" varchar NOT NULL, "financial_contribution_id" integer, "event_type" varchar NOT NULL, "created_at" datetime(6) NOT NULL, "refund_data" json DEFAULT '{}' NOT NULL /*application='SeosFrance'*/, CONSTRAINT "fk_rails_0fa16b380a"
FOREIGN KEY ("financial_contribution_id")
  REFERENCES "financial_contributions" ("id")
);
CREATE UNIQUE INDEX "index_payment_events_on_stripe_event_id" ON "payment_events" ("stripe_event_id") /*application='SeosFrance'*/;
CREATE INDEX "index_payment_events_on_financial_contribution_id" ON "payment_events" ("financial_contribution_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_organization_invitations_on_organization_id" ON "organization_invitations" ("organization_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_mission_applications_on_volunteer_mission_id" ON "mission_applications" ("volunteer_mission_id") /*application='SeosFrance'*/;
CREATE INDEX "index_mission_applications_on_user_id" ON "mission_applications" ("user_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_mission_applications_on_volunteer_mission_id_and_user_id" ON "mission_applications" ("volunteer_mission_id", "user_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_mission_messages_on_mission_application_id" ON "mission_messages" ("mission_application_id") /*application='SeosFrance'*/;
CREATE INDEX "index_mission_messages_on_user_id" ON "mission_messages" ("user_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "unique_mission_message" ON "mission_messages" ("mission_application_id", "user_id", "delivery_key") /*application='SeosFrance'*/;
...
CREATE INDEX "index_partnerships_on_organization_id" ON "partnerships" ("organization_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_partnerships_on_slug" ON "partnerships" ("slug") /*application='SeosFrance'*/;
CREATE INDEX "index_partnerships_on_approved_by_id" ON "partnerships" ("approved_by_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_cookie_consents_on_visitor_digest_and_created_at" ON "cookie_consents" ("visitor_digest", "created_at") /*application='SeosFrance'*/;
...
CREATE INDEX "index_data_requests_on_user_id" ON "data_requests" ("user_id") /*application='SeosFrance'*/;
CREATE INDEX "index_data_requests_on_reviewed_by_id" ON "data_requests" ("reviewed_by_id") /*application='SeosFrance'*/;
CREATE INDEX "index_data_requests_on_approved_by_id" ON "data_requests" ("approved_by_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "unique_open_data_request" ON "data_requests" ("user_id", "kind") WHERE status IN ('pending','reviewed','executing') /*application='SeosFrance'*/;
...
CREATE INDEX "index_retention_policy_versions_on_created_by_id" ON "retention_policy_versions" ("created_by_id") /*application='SeosFrance'*/;
CREATE INDEX "index_retention_policy_versions_on_approved_by_id" ON "retention_policy_versions" ("approved_by_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_privacy_runs_on_retention_policy_version_id" ON "privacy_runs" ("retention_policy_version_id") /*application='SeosFrance'*/;
CREATE INDEX "index_privacy_runs_on_actor_id" ON "privacy_runs" ("actor_id") /*application='SeosFrance'*/;
CREATE INDEX "index_privacy_runs_on_approved_by_id" ON "privacy_runs" ("approved_by_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_provider_erasure_tasks_on_data_request_id" ON "provider_erasure_tasks" ("data_request_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_provider_erasure_tasks_on_data_request_id_and_provider" ON "provider_erasure_tasks" ("data_request_id", "provider") /*application='SeosFrance'*/;
...
CREATE INDEX "index_studio_versions_on_author_id" ON "studio_versions" ("author_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_bulk_operations_on_actor_id" ON "bulk_operations" ("actor_id") /*application='SeosFrance'*/;
CREATE INDEX "index_bulk_operations_on_approved_by_id" ON "bulk_operations" ("approved_by_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_login_blocks_on_actor_id" ON "login_blocks" ("actor_id") /*application='SeosFrance'*/;
CREATE INDEX "index_login_blocks_on_email_digest" ON "login_blocks" ("email_digest") /*application='SeosFrance'*/;
...
CREATE INDEX "index_google_identities_on_user_id" ON "google_identities" ("user_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_google_identities_on_uid" ON "google_identities" ("uid") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "one_google_identity_per_user" ON "google_identities" ("user_id") /*application='SeosFrance'*/;
...
CREATE UNIQUE INDEX "index_mail_deliveries_on_message_id" ON "mail_deliveries" ("message_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_studio_assets_on_author_id" ON "studio_assets" ("author_id") /*application='SeosFrance'*/;
...
CREATE INDEX "index_crawler_policies_on_author_id" ON "crawler_policies" ("author_id") /*application='SeosFrance'*/;
CREATE TABLE IF NOT EXISTS "referral_settings" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "minimum_age_days" integer DEFAULT 30 NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT referral_settings_singleton CHECK (id = 1 AND minimum_age_days >= 0));
CREATE TABLE IF NOT EXISTS "referral_links" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "owner_id" integer NOT NULL, "token" varchar NOT NULL, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, CONSTRAINT "fk_rails_6e1b100b79"
FOREIGN KEY ("owner_id")
  REFERENCES "users" ("id")
);
CREATE UNIQUE INDEX "index_referral_links_on_owner_id" ON "referral_links" ("owner_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "index_referral_links_on_token" ON "referral_links" ("token") /*application='SeosFrance'*/;
CREATE TABLE IF NOT EXISTS "referrals" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "referral_code_id" integer, "referrer_id" integer NOT NULL, "referred_user_id" integer NOT NULL, "position" integer NOT NULL, "primary_referrer" boolean DEFAULT FALSE NOT NULL, "status" varchar DEFAULT 'provisional' NOT NULL, "claimed_at" datetime(6) NOT NULL, "objection_deadline_at" datetime(6) NOT NULL, "confirmed_at" datetime(6), "qualified_at" datetime(6), "invalidated_at" datetime(6), "invalidation_reason" text, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "referral_link_id" integer, CONSTRAINT "fk_rails_c65f8d2b8d"
...
, CONSTRAINT "fk_rails_6f6a7af048"
...
CREATE INDEX "index_referrals_on_referral_link_id" ON "referrals" ("referral_link_id") /*application='SeosFrance'*/;
CREATE UNIQUE INDEX "one_invitation_per_member" ON "referrals" ("referred_user_id") WHERE referral_link_id IS NOT NULL /*application='SeosFrance'*/;
CREATE TABLE IF NOT EXISTS "users" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar COLLATE "NOCASE" NOT NULL, "encrypted_password" varchar DEFAULT '' NOT NULL, "role" varchar DEFAULT 'member' NOT NULL, "status" varchar DEFAULT 'pending' NOT NULL, "reset_password_token" varchar, "reset_password_sent_at" datetime(6), "confirmation_token" varchar, "confirmed_at" datetime(6), "confirmation_sent_at" datetime(6), "unconfirmed_email" varchar, "failed_attempts" integer DEFAULT 0 NOT NULL, "locked_at" datetime(6), "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "email_notifications" boolean DEFAULT TRUE NOT NULL, "pending_referral_link_id" integer, CONSTRAINT "fk_rails_2ccbe8c7c0"
FOREIGN KEY ("pending_referral_link_id")
  REFERENCES "referral_links" ("id")
, CONSTRAINT users_role CHECK (role IN ('member', 'admin', 'super_admin')), CONSTRAINT users_status CHECK (status IN ('pending', 'active', 'suspended', 'anonymized')), CONSTRAINT users_normalized_email CHECK (email = lower(trim(email)) AND length(email) > 0));
