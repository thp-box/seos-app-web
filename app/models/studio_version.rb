class StudioVersion < ApplicationRecord
  ...
  PAGES = %w[legal home don echange points communaute voyage-solidaire].freeze
  ...
  def available_pages = (PAGES + site.fetch("pages", {}).keys).uniq - deleted_pages - [ "fonctionnement" ]
  def chrome(area)
